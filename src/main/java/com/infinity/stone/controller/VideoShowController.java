...
public class VideoShowController implements Initializable,BaseVideoController.OnVideoControllerListener {
    ...
    private void setUpVideoController() {
        ...
        controller = new VideoController(videoPlayer,
                new VideoModel("video.mp4",mSubtitleCollection,LEVEL.ADVANCE),
                new ArrayList<>());
    ...
    private void setUpListSubTitle() {
        ...
        listViewSubtitle.setCellFactory(
                  ...
                  new ListViewCell(favouriteRepo,listViewSubtitle));
        listViewSubtitle.setOnMouseClicked(event->{
        	controller.calculatedClickSub(TextUtils
        			.reverseFormatTime(((Subtitle)listViewSubtitle.getSelectionModel().getSelectedItem()).getTimeStart()));
        });
    }
    ...
    static class ListViewCell extends JFXListCell<Subtitle> {
        ...
        private final FavoriteRepository favouriteRepo;
        public ListViewCell(FavoriteRepository favoriteRepository ,JFXListView listViewSubtitle) {
        	this.favouriteRepo = favoriteRepository;
        ...
        protected void updateItem(Subtitle item, boolean empty) {
            ...
            try {
                ...
                if (item != null) {
                    ...
                    button.setOnMouseClicked(clickAddFavouriteHandle);
                    hbox.setSpacing(30);
        ...
        EventHandler clickAddFavouriteHandle = new EventHandler<Event>() {

			@Override
			public void handle(Event event) {
				favouriteRepo.create(new Favorite(null, null));
			}
